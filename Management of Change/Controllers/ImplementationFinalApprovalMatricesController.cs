...
{
    public class ImplementationFinalApprovalMatricesController : Controller
    {
        private readonly Management_of_ChangeContext _context;

        public ImplementationFinalApprovalMatricesController(Management_of_ChangeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,ChangeType,FinalReviewType,CreatedUser,CreatedDate,ModifiedUser,ModifiedDate,DeletedUser,DeletedDate")] ImplementationFinalApprovalMatrix implementationFinalApprovalMatrix)
        {
            ...
            implementationFinalApprovalMatrix.ModifiedUser = "Michael Wilson";

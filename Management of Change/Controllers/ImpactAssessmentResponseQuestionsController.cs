...
{
    public class ImpactAssessmentResponseQuestionsController : Controller
    {
        private readonly Management_of_ChangeContext _context;

        public ImpactAssessmentResponseQuestionsController(Management_of_ChangeContext context)
        {
            _context = context;
        }
